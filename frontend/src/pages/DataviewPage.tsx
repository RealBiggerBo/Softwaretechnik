...
function DataviewPage({ caller }: Props) {
  ...
  const [selectedStaatsangehörigkeit, setSelectedStaatsangehörigkeit] =
    useState("");
  const [selectedwohnort, setSelectedwohnort] = useState("");
  const [selectedSchwerbehinderung, setSelectedSchwerbehinderung] =
    useState("");
      ...
      {selected === "Anfrage" && (
        <div>
          <form action={"anfrage.html"} method={"get"}>
            ...
            <br />
            <label htmlFor="anfrage_termin">
              Wurde bereits ein Termin vergeben?{" "}
            </label>
            <select
              name="anfrage_termin"
            ...
            <button
              onClick={async (e) => {
                e.preventDefault();
                const result = await caller.TryCreateAnfrage(
                  new Anfrage(
                    "Art",
                    "2026-01-07",
                    "S",
                ...
                else alert("Speichern erfolgreich");
              }}
            >
              Speichern
            </button>
          ...
          <form action={"fall.html"} method={"get"}>
            ...
            <fieldset style={{ width: "450px" }}>
              ...
              <table style={{ textAlign: "right" }}>
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_rolle">
                      Rolle der ratsuchenden Person:{" "}
                    </label>
                  </td>
                  <td>
                    <select name="fall_rolle">
                      <option>Betroffene:r</option>
                      <option>Angehörige:r</option>
                      <option>Fachkraft</option>
                    </select>
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_geschlecht">
                      Geschlächtsidentität:{" "}
                    </label>
                  </td>
                  <td>
                    <select name="fall_geschlecht">
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_sexualitaet">Sexualität: </label>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <select
                      name="fall_wohnort"
                      onChange={(e) => setSelectedwohnort(e.target.value)}
                    >
                      <option>keine Angabe</option>
                      <option>Leipzig Stadt</option>
                      <option>Leipzig Land</option>
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_staatsangehoerigkeit">
                      Staatsangehörigkeit:{" "}
                    </label>
                  </td>
                  <td>
                    <select
                      name="fall_staatsangehoerigkeit"
                      onChange={(e) =>
                        setSelectedStaatsangehörigkeit(e.target.value)
                      }
                    >
                      <option>Deutschland</option>
                      <option>andere</option>
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_schwerbehinderung">
                      Schwerbehinderung:{" "}
                    </label>
                  </td>
                  <td>
                    <select
                      name="fall_schwerbehinderung"
                      onChange={(e) =>
                        setSelectedSchwerbehinderung(e.target.value)
                      }
                    >
                      <option>Nein</option>
                      <option>Ja</option>
            ...
            <fieldset style={{ width: "450px" }}>
              ...
              <table style={{ textAlign: "right" }}>
                <tr>
                  <td>
                    <label htmlFor="fall_beratungsstelle">
                      zuständige Beratungsstelle:{" "}
                    </label>
                  </td>
                  <td>
                    <select
                      name="fall_beratungsstelle"
                      style={{ width: "200px" }}
                    >
                      <option>Bitte auswählen</option>
                      <option>
                      ...
                      <option>
                        Fachberatung gegen sexualusierte Gewalt Landkreis
                        Leipzig
                      </option>
                    </select>
                  </td>
                ...
                <tr>
                  <td>
                    <label htmlFor="fall_anzahl_beratung">
              ...
              {Array.from({ length: anzahlTermin }).map((_, i) => (
                <div key={i}>
                  <fieldset>
            ...
            <fieldset style={{ width: "450px" }}>
              ...
              <table style={{ textAlign: "right" }}>
                ...
                <tr>
                  ...
                  <td>
                    <select
                      name="zeitraum"
                      onChange={(e) => setSelectedzeitraum(e.target.value)}
                    >
              ...
              {Array.from({ length: anzahlTäter }).map((_, i) => (
                <div key={i}>
                  <fieldset>
                    ...
                    <table style={{ textAlign: "right" }}>
                      ...
                      <tr>
                        <td>
                          <label htmlFor="dropdown17">
                            Verhältnis zur ratsuchenden Person:{" "}
                          </label>
                        </td>
                        <td>
            ...
            <fieldset style={{ width: "450px" }}>
              ...
              <table style={{ textAlign: "right" }}>
                ...
                <tr>
                  <td>
                    <label htmlFor="dropdown23">
                      Arbeitseinschränkungen/Arbeitsunfähigkeit:{" "}
                    </label>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <input
                      type="text"
                      placeholder="weitere Informationen/Notizen"
                    />
                  </td>
                </tr>
              </table>
            ...
            <fieldset style={{ width: "450px" }}>
              <h3>Weitere Daten</h3>
              <label htmlFor="dropdown27">
                Woher hat die ratsuchende Person von der Beratungsstelle
                erfahren:{" "}
              </label>
              ...
              <br />
              <label htmlFor="dropdown28">
                Wurden Dolmetscherstunden in Anspruch genommen:{" "}
              </label>
              <select
                name="dropdown28"
                onChange={(e) => setSelectedDolmetscher(e.target.value)}
              >
                <option>Nein</option>
                <option>Ja</option>
              </select>
            ...
            <button
              onClick={async (e) => {
                e.preventDefault();
                const result = await caller.TryCreateCase(
                  new Case(
                    "Alias",
                    "A",
                    22,
